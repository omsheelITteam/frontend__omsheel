          ...
          <div className="grid-container ">
            {groupWorks.map((menu, index) => (
              <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="grid-card transition-transform duration-300 ease-in-out transform hover:scale-105 items-center justify-center"
              >
      ...
      <div className="flex items-center justify-center gap-6 flex-wrap  px-6 py-7">
        {subWorks.map((content, index) => (
          ...
          >
            ...
            <div className="text">
              <p className="h3 text-2xl text-pink-600 font-semibold text-center">
                {content.title}
              </p>
