          ...
          <form className="space-y-5" onSubmit={onsubmitNewPassword}>
            <div className="relative">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-500 text-white py-2 rounded-full font-semibold tracking-wide shadow-md  transition-transform duration-300 ease-in-out transform hover:scale-105 mt-8"
              >
                {isLoading ? (
                  <span className="flex justify-center items-center">
                    <FaSpinner className="animate-spin text-white text-2xl" />
