      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative bg-white">
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div className="text-center md:text-left space-y-6 lg:max-w-[440px]">
            ...
            >
              <span className="text-4xl lg:text-6xl text-pink-600">Omsheel</span> <span className="text-4xl lg:text-5xl text-black">Group</span> 
            </motion.h1>
            <motion.p
            ...
            >
              <button className="primary-btn flex gap-2 items-center" onClick={()=>navigate('/about')}>
                <span>
                  <FaBookOpen />
                </span>
                Know More
